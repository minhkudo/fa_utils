...
class HybridImage extends StatefulWidget {
  ...
  HybridImage._({
    ...
    this.headers,
  })  : assert(type == HybridImageType.network || type == HybridImageType.asset || type == HybridImageType.file),
        assert(type == HybridImageType.network ? imageUrl != null && Uri.parse(imageUrl).isAbsolute : true),
        assert(type == HybridImageType.asset ? assetPath != null && assetPath.isNotEmpty : true),
